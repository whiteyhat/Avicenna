  ...
  generatePDF(data, name) {
    ...
    try {
      ...
      if (data.blockchain) {
        ...
        .moveDown()
        // Add body
        .text("Avicenna certifies that the atached file identified with hash: ", {
          width: 470,
          align: 'justify',
          indent: 30,
          height: 300,
        ...
        .fillColor('black')
        .font('public/fonts/roboto.ttf', 13)
        .text( "At this moment the transaction was validated as success by " + validation + " blocks. And for the record, Avicenna issues this certificate with date " + this.formatDate(new Date) + ".",{
          width: 470,
          align: 'justify',
          indent: 30,
          height: 300,
